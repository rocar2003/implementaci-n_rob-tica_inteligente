...
#include "yolo_msg/msg/detail/yolov8_inference__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yolo_msg::msg::InferenceResult &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yolo_msg::msg::InferenceResult &);
size_t get_serialized_size(
  const yolo_msg::msg::InferenceResult &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const yolo_msg::msg::Yolov8Inference & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolo_msg::msg::Yolov8Inference & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: yolov8_inference
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yolo_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_InferenceResult(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = yolo_msg::msg::Yolov8Inference;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yolo_msg::msg::Yolov8Inference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_msg::msg::Yolov8Inference *>(
    untyped_ros_message);
...
{
  return &yolo_msg::msg::typesupport_fastrtps_cpp::_Yolov8Inference__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_msg, msg, Yolov8Inference)() {
  return &yolo_msg::msg::typesupport_fastrtps_cpp::_Yolov8Inference__handle;
}
