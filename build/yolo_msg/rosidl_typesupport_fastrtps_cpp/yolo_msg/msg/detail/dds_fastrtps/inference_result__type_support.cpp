...
#include "yolo_msg/msg/detail/inference_result__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolo_msg::msg::InferenceResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yolo_msg::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_msg::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  return &yolo_msg::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
