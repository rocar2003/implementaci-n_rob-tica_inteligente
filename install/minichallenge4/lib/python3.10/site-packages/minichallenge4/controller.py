    ...
    def main_timer_cb(self):
        if self.state == 'stop':
            ...
            if self.first_time: 
                ...
                '''elif self.cont == 1:
                    self.xG = self.get_parameter('p1.x').get_parameter_value().double_value
                    self.yG = self.get_parameter('p1.y').get_parameter_value().double_value
                

                elif self.cont == 2:
                    self.xG = self.get_parameter('p2.x').get_parameter_value().double_value
                    self.yG = self.get_parameter('p2.y').get_parameter_value().double_value
                

                elif self.cont == 3:
                    self.xG = self.get_parameter('p3.x').get_parameter_value().double_value
                    self.yG = self.get_parameter('p3.y').get_parameter_value().double_value
            

                elif self.cont == 4:
                    self.xG = self.get_parameter('p4.x').get_parameter_value().double_value
                    self.yG = self.get_parameter('p4.y').get_parameter_value().double_value'''
