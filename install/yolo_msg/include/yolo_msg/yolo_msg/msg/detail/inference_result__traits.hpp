...
#ifndef YOLO_MSG__MSG__DETAIL__INFERENCE_RESULT__TRAITS_HPP_
#define YOLO_MSG__MSG__DETAIL__INFERENCE_RESULT__TRAITS_HPP_
...
inline void to_yaml(
  const yolo_msg::msg::InferenceResult & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const yolo_msg::msg::InferenceResult & msg)
{
  return yolo_msg::msg::to_yaml(msg);
}

template<>
inline const char * data_type<yolo_msg::msg::InferenceResult>()
{
  return "yolo_msg::msg::InferenceResult";
}

template<>
inline const char * name<yolo_msg::msg::InferenceResult>()
{
  return "yolo_msg/msg/InferenceResult";
}

template<>
struct has_fixed_size<yolo_msg::msg::InferenceResult>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<yolo_msg::msg::InferenceResult>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<yolo_msg::msg::InferenceResult>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // YOLO_MSG__MSG__DETAIL__INFERENCE_RESULT__TRAITS_HPP_
